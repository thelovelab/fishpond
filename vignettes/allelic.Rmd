...
We can customize the labels displayed on the gene model:
...
adding an ideogram, and changing the labels for the alleles. See
`importAllelicGene()` manual page for more details.
