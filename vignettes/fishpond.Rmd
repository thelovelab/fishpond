...
Lastly, what is the structure of the output of `tximeta`, which is
...
# uncomment once macrophage 1.1.2 is available...
#library(tximeta)
#makeLinkedTxome(
...
and inferential replicate counts. `tximport` or `tximeta` functions
