...
The `swish` method for differential expression analysis using
inferential replicate counts is described in the following reference:
...
from the *samr* package for calculation of local FDR and q-value.
This vignette gives an example of differential analysis of matched
samples.
...
A note about `labelKeep`: by default we keep features with `minN`
...
number of cells being compared.
